...
if __name__ == '__main__':
    from GRANT_DOCTOR_MAPPING.npi_grants import grants_reader, npi_data
    grants_df = grants_reader.read_grants_year(2022)
    npi_df = npi_data.read('data/npidata_pfile_20240205-20240211.csv')
...
# ft_model.get_sentence_vector(s1.lower())
    ...
    # good feature care makes for a good model

    # ways to get data: handjamming, handjamming with some trained, and synthesize some